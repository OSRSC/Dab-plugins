...
class HydraSceneOverlay extends Overlay {
	...
	private final net.runelite.client.plugins.HydraAutoPrayers.HydraPlugin plugin;
	private final Client client;
	private final net.runelite.client.plugins.HydraAutoPrayers.HydraConfig config;

	@Inject
	public HydraSceneOverlay(final Client client, final net.runelite.client.plugins.HydraAutoPrayers.HydraPlugin plugin, final net.runelite.client.plugins.HydraAutoPrayers.HydraConfig config) {
		this.config = config;
	...
	private void drawFountain(Graphics2D graphics, net.runelite.client.plugins.HydraAutoPrayers.Hydra hydra) {
