...
import net.runelite.client.plugins.CerbAutoPrayers.domain.Cerberus;
import net.runelite.client.plugins.CerbAutoPrayers.domain.CerberusAttack;
import net.runelite.client.plugins.CerbAutoPrayers.domain.Ghost;
import net.runelite.client.plugins.CerbAutoPrayers.domain.Phase;
...
@Extension
@PluginDescriptor(
		name = "<html><font color=#19C2FF>Cerb Auto prayers",
...
public class CerbAutoPrayersPlugin extends Plugin
{
	...
	@Inject
	private CerbAutoPrayerConfig config;
	...
	@Provides
	public net.runelite.client.plugins.CerbAutoPrayers.CerbAutoPrayerConfig getConfig(
			ConfigManager configManager) {
		return configManager.getConfig(net.runelite.client.plugins.CerbAutoPrayers.CerbAutoPrayerConfig.class);
	}
